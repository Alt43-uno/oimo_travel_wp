...
class Booking {
	...
	public function init_hooks() {
		...
		add_action( 'wte_payment_gateway_payu_enable', array(
			$this,
		...
		add_action( 'restrict_manage_posts', array( $this, 'filter_booking_status' ) );
		add_action( 'parse_query', array( $this, 'filter_booking_status_value' ) );
