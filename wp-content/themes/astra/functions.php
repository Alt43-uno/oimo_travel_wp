...
function display_custom_tab_content($atts) {
    ...
    $tab_content = isset($settings['tab_content'][$atts['tab_key'] . '_wpeditor']) ? $settings['tab_content'][$atts['tab_key'] . '_wpeditor'] : 'No content found.';

    return wp_kses_post($tab_content);
}
add_shortcode('custom_tab', 'display_custom_tab_content');
